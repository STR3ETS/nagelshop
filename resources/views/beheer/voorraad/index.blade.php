    ...
    <div class="py-[1.5rem] max-w-[1100px] mx-auto">
        <div class="w-full flex items-center justify-between mb-6">
            <ul class="flex items-center gap-[2rem]">
                <li><a href="/beheer" class="hover:text-[#b38867] text-[15px] font-medium">Dashboard</a></li>
        ...
        <h1 class="text-[#191919] text-[38px] font-semibold leading-[1.15] mb-2">Beheer hier <i class="instrument-serif-font text-[#b38867]">jouw voorraad</i></h1>
        ...
        <div class="w-full bg-white p-[1.5rem] rounded-lg">
            ...
            <form action="{{ route('beheer.voorraad.bijwerken') }}" method="POST">
                            ...
                            <tr class="border-t border-gray-100">
                                ...
                                <td class="px-4 py-4">
                                    <input type="number"
                                           ...
                                           min="0"
                                           class="w-[200px] border ring-1 ring-gray-300 focus:ring-[#b38867] transition rounded px-2 py-1 text-start outline-none border-none">
                                </td>
                            </tr>
                        @empty
                            <tr>
                ...
                <div class="mt-2 text-right">
                    <button type="submit" class="px-6 py-2 bg-[#b38867] text-white rounded-md hover:bg-[#e652a7] transition">
                        Wijzigingen opslaan
                    </button>
                </div>
            </form>
