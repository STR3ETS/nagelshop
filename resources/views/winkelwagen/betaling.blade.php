...
@section('title', 'Bestelling bevestigen — Deluxe Nail Shop')
        ...
        <div class="w-full flex flex-col md:flex-row gap-[1rem]">
            ...
            <div class="w-full md:w-1/3 bg-white p-[1.5rem] rounded-lg h-fit">
                ...
                @php
                    ...
                    $levermethode = $gegevensSess['levermethode'] ?? 'verzenden';
                    ...
                    if ($levermethode === 'ophalen') {
                        ...
                        $gratisVerzendingDrempel = $drempel;

                        $verzendkosten = $totaalNaKorting >= $drempel ? 0.0 : $tarief;
                    }

                    // 4) Eindtotaal
                    $totaalMetVerzending = $totaalNaKorting + $verzendkosten;
