        ...
        <form action="{{ route('winkelwagen.contactOpslaan') }}" method="POST" class="w-full flex gap-[1rem]">
            ...
            <div class="bg-white p-[2rem] rounded-lg w-2/3 h-fit">
                <div class="mb-2">
                    ...
                    <input type="text" name="naam" required class="w-full px-[0.75rem] py-[0.55rem] ring-1 ring-gray-200 focus:ring-[#ff64ba] outline-none rounded-md">
                </div>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="adres" required class="w-full px-[0.75rem] py-[0.55rem] ring-1 ring-gray-200 focus:ring-[#ff64ba] outline-none rounded-md">
                </div>

                <div class="flex gap-4 mb-2">
                    <div class="w-1/2">
                        <label class="text-sm font-medium">Postcode</label>
                        <input type="text" name="postcode" required class="w-full px-[0.75rem] py-[0.55rem] ring-1 ring-gray-200 focus:ring-[#ff64ba] outline-none rounded-md">
                    </div>
                    <div class="w-1/2">
                        <label class="text-sm font-medium">Plaats</label>
                        <input type="text" name="plaats" required class="w-full px-[0.75rem] py-[0.55rem] ring-1 ring-gray-200 focus:ring-[#ff64ba] outline-none rounded-md">
                    </div>
                </div>
            </div>
